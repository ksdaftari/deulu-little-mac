...
* - [KO Punch Kill Percent](https://docs.google.com/spreadsheets/d/1Fht5zTeF1p6C-79gOIPfZCorS_AIDgmgTezSbnThcAg/edit?gid=0#gid=0)
  - For each character, perecent KO will at (not true confirm percent)
* - [Dtilt KO True Confirm](https://docs.google.com/document/d/1IBm9XXNfuSaUf9lqbgayGD2ionZH5Ct3KtDLZrCOnok/edit?tab=t.0)
  - For each character, percent winodw Dtilt > KO Punch is true
* - [Platform Tech Percents](https://docs.google.com/spreadsheets/d/1-JUhPbHset55frtVmJSOUVRbCGFCVpS6vHNYpJEH1r8/edit?gid=0#gid=0)
  - For each character, percents D-throw, U-tilt, D-tilt, UAFSmash will cause platform tech 
```

## Match Ups Vods Playlists

below is full list of [Notable Players](notable_players) vods per MU
